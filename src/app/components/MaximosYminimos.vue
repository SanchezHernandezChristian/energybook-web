<template>
  <div>
    <button @click="$bvModal.show(DataDesignated.id)" title="Click para ver/editar Maximos y minimos" variant="primary" class="btn">
    ...
    <b-modal :id="DataDesignated.id">
      ...
      <b-row>
        <b-col>
          <b-form-group label="Costo Maximo">
            <b-form-input v-model="max" required type="number" placeholder="Max"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="Amperaje Maximo">
            <b-form-input v-model="Amperajemax" required type="number" placeholder="Amperaje max"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col>
          <b-form-group label="Desbalance Maximo">
            <b-form-input v-model="DesbalanceMax" required type="number" placeholder="Desbalance max"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col>
          <b-form-group label="THD Maximo">
            <b-form-input v-model="Thdmax" required type="number" placeholder="THD Max"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col>
          <b-form-group label="Voltaje Maximo">
            <b-form-input v-model="VoltajeMax" required type="number" placeholder="Voltaje Max"></b-form-input>
          </b-form-group>
        </b-col>
        <b-col> </b-col>
      </b-row>
      ...
      <div slot="modal-footer">
        <b-row>
          <b-col>
            <b-button
              @click="guardar(DataDesignated.id, min, max), $bvModal.hide(DataDesignated.id)"
