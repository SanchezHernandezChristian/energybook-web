<template>
  <div class="create-pdf-container">
    <b-form-group label="Título del PDF" label-for="pdf-title">
      <b-form-input id="pdf-title" v-model="pdf.title" type="text" />
    </b-form-group>
    <b-form-group label="Link al archivo" label-for="pdf-link">
      <b-form-input id="pdf-link" v-model="pdf.link" type="text" />
    </b-form-group>
    <b-form-group label="Descripción" label-for="pdf-description">
      <b-form-textarea id="pdf-description" size="lg" v-model="pdf.description" type="text" />
    </b-form-group>
    <b-form-group label="Número de artículo" label-for="pdf-number">
      <b-form-input id="pdf-number" v-model="pdf.number" type="number" />
    </b-form-group>
    <b-btn @click="createPDF"> Subir archivo </b-btn>
    <b-btn @click="clearData"> Limpiar celdas </b-btn>
  </div>
</template>
