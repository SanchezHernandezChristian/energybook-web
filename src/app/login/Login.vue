<template id="template">
  <div id="login">
    ...
    <b-card id="login-container">
      <b-form @submit.prevent="login">
        ...
        <b-form-group id="login-user">
          <b-form-input type="text" v-model="email" required="required" placeholder="Usuario" autocomplete="on"></b-form-input>
        </b-form-group>
        <b-form-group id="login-password">
          <b-input-group>
            <b-form-input id="password" type="password" v-model="password" required="required" placeholder="Contraseña" autocomplete="on"></b-form-input>
        ...
        <br />
        <div align="left">
          <font size="1" align="left">by</font>
        </div>
    ...
    <b-modal id="modal-1" title="Olvidó su contraseña?  " @ok="handleOk">
      ...
      <b-form-group label="Nueva contraseña" label-for="name-input" invalid-feedback="Contraseña es necesario">
