<template>
  <div class="dashboard-parent">
        ...
        <b-row class="dashboard-content-user">
          <b-col>
                  ...
                  <template v-slot:body>
                    <b-row>
                      ...
                      <b-col md="10" class="dashboard-data-container">
                        <p>Consumo</p>
                        <h5>{{ consumption ? consumption : 0 }} kWh</h5>
                        <h5>$ {{ consumptionCost ? consumptionCost : 0 }}</h5>
                      </b-col>
                    </b-row>
                  </template>
                ...
                <reading-card>
                  ...
                  <template v-slot:body>
                    <b-row>
                      ...
                      <b-col md="10" class="dashboard-data-container">
                        <p>Capacidad</p>
                        <h5>{{ capacity ? capacity : 0 }} kW</h5>
                        <h5>$ {{ capacityCost ? capacityCost : 0 }}</h5>
                      </b-col>
                    </b-row>
                  </template>
                  <template v-slot:footer>Última actualización: {{ dailyLastUpdatedTime }}</template>
                ...
                <reading-card>
                  ...
                  <template v-slot:body>
                    <b-row>
                      ...
                      <b-col md="10" class="dashboard-data-container">
                        <p>Distribución</p>
                        <h5>{{ distribution ? distribution : 0 }} kW</h5>
                        <h5>$ {{ distributionCost ? distributionCost : 0 }}</h5>
                      </b-col>
                    </b-row>
                  </template>
                  <template v-slot:footer>Última actualización: {{ dailyLastUpdatedTime }}</template>
            ...
            <b-row class="margin-bottom-2">
              ...
              <b-col xl="3" class="mt-xl-0 mt-lg-4">
                <b-card class="dashboard-general" no-body>
                  <b-row class="analysis-card-header">
                    <b-col>
    ...
    <!--  -->
    <!-- 
    <b-row id="dashboard" class="main user-dashboard" v-if="!isAdmin && this.state.mode =='ACUVIM'">
      <b-col>
        <b-row class="dashboard-content-user">
          <b-col>
            <b-row class="margin-bottom-2 margin-top-1">
