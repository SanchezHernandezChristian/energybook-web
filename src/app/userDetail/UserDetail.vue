    ...
    <b-col>
      <b-card class="profile-header">
        ...
        <b-row class="header-bottom" align-h="around">
          <b-col>MIEMBRO DESDE {{ userCreatedAt }}</b-col>
          <b-col v-if="!isCompanyProfile">ÚLTIMO INICIO DE SESIÓN {{ userLastLogin }}</b-col>
        </b-row>
      </b-card>
      <b-row>
        <b-col>
            ...
            <b-tabs pills card>
                ...
                <b-row class="profile-company" v-if="!changePassword && !edit">
                  ...
                  <b-col>
                    ...
                    <b-form-group label="Ubicación">
                      ...
                      ></b-form-input>
                      <gmap-autocomplete v-if="editCompany" class="form-control"></gmap-autocomplete>
                    </b-form-group>
                  </b-col>
                </b-row>
                <b-row class="edit-buttons" v-if="edit || changePassword || editCompany">
                  <b-col md="6">
                    <b-button :variant="'primary'" class="right" @click="saveChanges()">Guardar</b-button>
              ...
              <b-tab title="Usuarios" v-if="isCompanyProfile">
                ...
                >
                  ...
                  <b-form-group label="Apellido" label-for="userLastname">
                    <b-form-input type="text" id="userLastname" v-model="newUser.lastname" />
                  </b-form-group>
                  <b-form-group label="Correo" label-for="userEmail">
